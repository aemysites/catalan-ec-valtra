...
## Environments
- Preview: https://main--catalan-ec-valtra--aemysites.aem.page/
- Live: https://main--catalan-ec-valtra--aemysites.aem.live/
- Block Library: https://main--catalan-ec-valtra--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `catalan-ec-valtra` directory in your favorite IDE and start coding :)
